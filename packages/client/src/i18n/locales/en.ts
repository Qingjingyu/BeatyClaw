export default {
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with BeatyClaw 数字员工',
    ...
    hermesHistory: 'BeatyClaw 数字员工 History',
    historyScopeHint: 'BeatyClaw 数字员工 history sessions grouped by source.',

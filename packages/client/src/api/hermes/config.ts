...
export async function fetchWeixinStatus(): Promise<ConnectorStatus> {
  return request<ConnectorStatus>('/api/hermes/weixin/status')
}

export async function fetchTelegramStatus(): Promise<ConnectorStatus> {
  return request<ConnectorStatus>('/api/hermes/telegram/status')
}

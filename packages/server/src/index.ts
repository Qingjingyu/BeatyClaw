...
export async function bootstrap() {
  ...
  if (authToken) {
    console.log('Legacy token auth enabled')
    logger.info('Legacy token auth enabled')
  } else {
    console.log('Agentic owner login enabled')
    logger.info('Agentic owner login enabled')
  }

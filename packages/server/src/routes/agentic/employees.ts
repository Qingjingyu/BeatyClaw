...
employeeRoutes.post('/api/employees/:id/hide', ctrl.hide)
employeeRoutes.post('/api/employees/:id/show', ctrl.show)
employeeRoutes.post('/api/employees/:id/restore', ctrl.restore)
employeeRoutes.delete('/api/employees/:id', ctrl.remove)
...
employeeRoutes.post('/api/employees/:id/health', ctrl.health)

...
authPublicRoutes.post('/api/yoyoo/auth/login', ctrl.yoyooLogin)

// Protected routes (auth required)
export const authProtectedRoutes = new Router()
authProtectedRoutes.get('/api/yoyoo/me', ctrl.yoyooMe)
authProtectedRoutes.post('/api/yoyoo/auth/logout', ctrl.yoyooLogout)
